...
//    } yield c)
//
//    Set(c2.unsafeRunSync().compile.toList) shouldBe Set()
//
//    store.close()
//  }
//
...
//    } yield s)
//
//    Set(s.unsafeRunSync().compile.toList) shouldBe Set()
//    store.close()
//  }
//
...
//    } yield s)
//
//    s.unsafeToFuture().value.get.get.
//
//    s.unsafeRunSync().compile.toList.unsafeRunSync().map(_.statement)
//    Set(s.unsafeRunSync().compile.to.toList.map(_.statement)) shouldBe
...
//      s <- tx.allStatements(testCollection)
//    } yield s)
//    s.unsafeRunSync().compile.toList.map(_.statement)) shouldBe
...
//      s <- tx.allStatements(testCollection)
//    } yield s)
//    s.unsafeRunSync().compile.toList.map(_.statement)) shouldBe Set(
...
//    } yield (s, s2))
//
//    s.unsafeRunSync()._1.compile.toList.map(_.statement)) shouldBe Set()
//    s.unsafeRunSync()._2.compile.toList.map(_.statement)) shouldBe Set()
//    store.close()
//  }
//
...
//    s.unsafeRunSync()._3.compile.toList.map(_.statement)) shouldBe Set(
//      Statement(valjean, Predicate("nationality"), StringLiteral("French")),
//      Statement(valjean, Predicate("prisonNumber"), LongLiteral(24601)))
//    s.unsafeRunSync()._4.compile.toList.map(_.statement)) shouldBe Set(
//      Statement(javert, Predicate("nationality"), StringLiteral("French")))
//    s.unsafeRunSync()._5.compile.toList.map(_.statement)) shouldBe Set(
//      Statement(valjean, Predicate("nationality"), StringLiteral("French")),
//      Statement(valjean, Predicate("prisonNumber"), LongLiteral(24601)),
//      Statement(javert, Predicate("nationality"), StringLiteral("French")))
//
